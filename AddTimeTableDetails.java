 ...
 * @author Ganesh
 */
@WebServlet(name = "AddTimeTableDetails", urlPatterns = {"/AddTimeTableDetails"})
public class AddTimeTableDetails extends HttpServlet implements Constant {
     HttpSession session;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        url_path = "./add_time_table_details.jsp";
        ...
        String labId = request.getParameter("lab_id_text");
        ...
        timeTableDetails.setLabId(Integer.parseInt(labId));
        ...
        if(timeTableDao.isTimeTablePracticalDetails(timeTableDetails)){
            ...
            if(timeTableDao.insertTimeTablePracticalDetails(timeTableDetails)){
